...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ScribbleArea_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ScribbleArea_t qt_meta_stringdata_ScribbleArea = {
    {
QT_MOC_LITERAL(0, 12), // "ScribbleArea"
QT_MOC_LITERAL(13, 10), // "clearImage"
QT_MOC_LITERAL(24, 0), // ""
QT_MOC_LITERAL(25, 5) // "print"

    },
    "ScribbleArea\0clearImage\0\0print"
};
...
void ScribbleArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ScribbleArea *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject ScribbleArea::staticMetaObject = { {
    ...
    qt_meta_stringdata_ScribbleArea.offsetsAndSize,
    qt_meta_data_ScribbleArea,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ScribbleArea_t
, QtPrivate::TypeAndForceComplete<ScribbleArea, std::true_type>
